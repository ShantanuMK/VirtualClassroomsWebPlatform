...
*/
  ...
  if (isset($_POST['examre'])) {
    header("Location:sexamre.php");
  }
  if (isset($_POST['live'])) {
    header("Location:sslive.php");
  }
  ...
  if (isset($_POST['exam'])) {
    ...
    $a1=mysqli_query($conn,"SELECT * FROM exam WHERE subid=$subid");
    ...
    $ssid=$_SESSION['sid'];
    $eeid=$r12['eid'];
    if ((strtotime($current_date)==strtotime($r12['edate'])) and $current_time>=$extime and $current_time<=$eetime) {
      ...
      echo '<script>alert("Exam is Not Yet Posted")</script>';
    }
  }
?>
<!DOCTYPE html>
  ...
  <div class="site-wrap">
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
      ...
      <?php
          ...
          $a=mysqli_query($conn,"SELECT * FROM exam WHERE subid=$subid");
          $b=mysqli_num_rows($a);
          //echo $b;
          if ($b>0) {
            $result=mysqli_query($conn,"SELECT * FROM exam where subid=$subid and eid=(SELECT MAX(eid) FROM exam where subid=$subid )"); 
