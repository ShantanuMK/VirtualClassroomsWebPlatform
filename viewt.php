    ...
    <div class="site-section">
        <div class="container">
            <form method="post" class="billing-form" enctype="multipart/form-data">
                        ...
                        <label for="username">View Teachers</label>
                        <form> <select class="form-control" name="users" onchange="showUser(this.value)" required><option value="">Select Teacher:</option>';
                              ...
                              {
                                $file_id=$row11['tid'];
                                $subj="SELECT COUNT(*) from subjects where tid=$file_id";
                                $sub_result=mysqli_query($conn,$subj);
                                $subjects_num=mysqli_fetch_assoc($sub_result);

                                echo '<option value='.$row11["tid"].'>'.$row11["tname"].'('.$subjects_num["COUNT(*)"].')</option>';
                    ...
                    <div class="row">
                        <div class="col-12">
                            <a href="addteacher.php" class="btn btn-primary btn-lg px-5">Add New Teacher</a><br><br>
                            <a href="removet.php" class="btn btn-primary btn-lg px-5">Remove Teacher</a><br><br>
                            <a href="dash_admin.php" class="btn btn-primary btn-lg px-5">Back</a>
                        </div>
                    </div>
                  </form>
