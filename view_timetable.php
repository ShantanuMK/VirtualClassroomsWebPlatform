<?php
  ...
  if (isset($_POST['upload'])) {
    ...
    $image = 'timage_'.$class.'_'.$div.'.'.$extension;
    $image = 'timage_'.$class.'_'.$div.'_'.$school_id.'.'.$extension;
    $target = "images/".basename($image);
    
    $allowed = array('jpg','jpeg','png','PNG');
    if(in_array($extension, $allowed))
        {
              $gi=mysqli_query($conn,"SELECT * FROM timetable where sstd=$class and sdiv='$div' and school_id=$school_id");
              $gii=mysqli_fetch_assoc($gi);
              $rimage=$gii['iname'];
              unlink("images/$rimage");
              mysqli_query($conn,"DELETE FROM timetable where sstd=$class and sdiv='$div' ");
              if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
                 $sq="INSERT INTO timetable (sstd,sdiv,iname,school_id) VALUES ($class,'$div','$image',$school_id)";
                    // "INSERT INTO timetable (sstd,sdiv,iname,school_id) VALUES (4,'A','timage_0',1)"
        ...
        <div class="container">
            <div class="row">
              <div class="col-md-4 mb-4">
                ...
                <form action="view_timetable.php" method="post" class="billing-form" enctype="multipart/form-data"> 
                <div class="col-lg-7 ml-auto align-self-center">
                  <div class="col-md-30 form-group">
                         
                      <div class="col-md-12 form-group">
                            <label for="Fees">Timetable Image (Only in 'jpeg','jpg','png')</label>
                            <div>
