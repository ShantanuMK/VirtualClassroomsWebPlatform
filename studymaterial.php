    ...
    if($extension1=='pdf')
        {
              ...
              if (move_uploaded_file($_FILES['file']['tmp_name'], $target1)) {
               ...
               // $sq="INSERT INTO subfiles (subid,filename,ftname,ftype) VALUES ($subid,'$file','$fname',2)";
                mysqli_query($conn,"INSERT INTO `subfiles`(`subid`, `filename`, `ftname`, `ftype`) VALUES ($subid,'$file','$fname',2)");
                header("Location:viewsub.php");

              }else{
                echo '<script>alert("Failed To Uplod File");</script>';
              }
