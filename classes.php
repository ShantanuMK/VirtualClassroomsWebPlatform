  ...
  <div class="site-wrap">
    ...
    <div class="site-section">
        <div class="container">
            <div class="row">
              <?php
                $sql="select DISTINCT sstd,sdiv from class where school_id=$school_id";
                ...
                while($row=mysqli_fetch_array($result))
                {
                  ...
                  $result2=mysqli_query($conn,"SELECT COUNT(*) FROM subjects where substd=$class and subdiv='$div' and school_id=$school_id");
