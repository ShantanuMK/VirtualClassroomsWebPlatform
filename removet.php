<?php
  ...
  if (isset($_POST['remove'])) {
    $tid=$_POST['rtid'];
    //echo $tid;
    mysqli_query($conn,"DELETE FROM teachers where tid=$tid" );
  }
  //echo $tid;
?>
<!DOCTYPE html>
    ...
    <div class="site-section ftco-subscribe-1 site-blocks-cover pb-4" style="background-image: url('images/bg_1.jpg')">
        <div class="container">
          <div class="row align-items-end">
            <div class="col-lg-7">
              <center><h2 class="mb-0"> Teachers</h2></center>
          ...
          <div class="col-md-12 ftco-animate">
            <div class="cart-list">
              <table class="table">
                ...
                <tbody>
                  <?php     
                 $c1=mysqli_query($conn,"SELECT * FROM teachers WHERE school_id=$school_id ");
                  while ($row=mysqli_fetch_array($c1)) {
                    ...
                    <td>'.$row["tmobile"].'</td>
                    ';
                    echo "<td><form method='post' action='removet.php'><input type='hidden' name='rtid' value=".$row["tid"]."><input type='submit' class='btn btn-primary py-3 px-4' name='remove' value='Remove'></form></td>";
                  echo "</tr>";
                 }
    ...
    ?>
            ...
            <div class="row">
                        <div class="col-12">
                          ...
                          <pre>          <a href="dash_admin.php" class="btn btn-primary btn-lg px-5">Back</a></pre>
                        </div>
           </div>
